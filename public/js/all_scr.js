...
$(document).ready(function () {
  ...
  $('.reg_btn').on('click', function () {
    "use strict";
  $('#R-autorized').removeClass("none");
})

$('#R-closeau').on('click', function () {
    "use strict";
  $('#R-autorized').addClass("none");
})
...
$('.out_btn').on('click',function (event) {
  ...
  console.log('log');
  // $(window).attr('localisation', 'https://www.w3schools.com')
