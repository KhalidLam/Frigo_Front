                  ...
                  <div className="uk-grid-medium uk-flex-middle" data-uk-grid>
                    ...
                    <div className="uk-width-expand">
                      <h4 className="uk-comment-title uk-margin-remove">
                        <a href="#saee" className="uk-link-reset">
                          {item.name}
                        </a>
                      </h4>
                      <p className="uk-comment-meta uk-margin-remove">
                        <a href="#saede" className="uk-link-reset">
                          {item.date}
                        </a>
                      </p>
                      ...
                      <div className="d-flex justify-content-between">
                        ...
                        {item.user_id === localStorage.userId && (
                          ...
                          >
                            ...
                            <BsTrash
                              color="red"
                              onClick={(e) => HandelDeleteComment(item.id)}
                              style={{ cursor: "pointer" }}
                            />
                          </div>
                        )}
