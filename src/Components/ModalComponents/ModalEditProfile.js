                  ...
                  <Box className="col-6 ">
                    ...
                    <Form.Group controlId="nom">
                      ...
                      <Form.Control
                        className="input"
                        onChange={handelChange}
                        defaultValue={props.User.profile.nom}
                      />
                    </Form.Group>
                    <Form.Group controlId="age">
                      ...
                      <Form.Control
                        className="input"
                        onChange={handelChange}
                        defaultValue={props.User.profile.age}
                      />
                    </Form.Group>
                    ...
                    <Form.Group controlId="poids">
                      ...
                      <Form.Control
                        ...
                        className="input"
                        onChange={handelChange}
                        defaultValue={props.User.profile.poids}
                      />
                    </Form.Group>
                  </Box>
                  ...
                  <Box className="col-6 ">
                    ...
                    <Form.Group controlId="prenom">
                      ...
                      <Form.Control
                        className="input"
                        onChange={handelChange}
                        defaultValue={props.User.profile.prenom}
                      />
                    </Form.Group>
                    <Form.Group controlId="taille">
                      ...
                      <Form.Control
                        ...
                        className="input"
                        onChange={handelChange}
                        defaultValue={props.User.profile.taille}
                      />
                    </Form.Group>
