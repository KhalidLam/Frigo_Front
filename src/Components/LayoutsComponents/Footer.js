                ...
                <h2  className=" title1"> FriKocina</h2>
                        ...
                        <div className="uk-flex uk-flex-middle uk-flex-right@s">
                            <div data-uk-grid className="uk-child-width-auto uk-grid-small">
                                <div>
                                    <a
                                        href="https://github.com/IkramELMAACHI/Frigo_Front/"
                                        data-uk-icon="icon: github-alt; ratio: 0.8"
                                        className="uk-icon-button github-alt"
                                        target="_blank"
                                    />
                                </div>
                                <div>
                                ...
                                <div>
                                    <a
                                        href="https://www.linkedin.com/in/ikramelmaachi/"
                    ...
                    <div className="uk-margin-medium-top uk-text-small uk-text-muted">
                        <div>
                            Made by  <a href="https://github.com/IkramELMAACHI/Frigo_Front" style = {{textDecoration : 'none'}}> EL MAACHI Ikram </a> in Casablanca City, Morocco.
        </div>
                    </div>
                </div>
            </footer>
