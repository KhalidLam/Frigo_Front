        ...
        <div className="uk-container">
          <ul className="uk-navbar-nav uk-visible@m uk-margin-large-left">
            <li className="uk-active">
              <Link to="/">
                <h2 className=" title2"> Accueil </h2>{" "}
              </Link>
            </li>
            ...
            <li>
              <Link to="/login">
                {" "}
                <h2 className=" title2"> Se connecter </h2>{" "}
              </Link>
            </li>
            <li>
              <Link to="/register">
                {" "}
                <h2 className=" title2"> S'inscrire </h2>{" "}
              </Link>
            </li>
          </ul>
        </div>
      ...
      <>
        ...
        <ul className="uk-navbar-nav uk-visible@m uk-margin-large-left ">
          ...
          <li>
            <Link to="/Recettes">
              {" "}
              <h2 className=" title2"> Recettes </h2>{" "}
            </Link>
          </li>
          <li className=" title">
            <Link to="/frigo">
              {" "}
              <h2 className=" title2"> Mon Frigo </h2>{" "}
            </Link>
          </li>
        </ul>
          ...
          <li className="dropdown">
            <Link to="/profile">
              ...
              <div style={{ width: "40px", marginLeft: "12px" }}>
                <img
                  src={`http://localhost:1000/${localStorage.avatar}`}
            ...
            <ul className="dropdown-content text-center">
              <li>
                <Link to="/profile">
                  {" "}
                  <h2 className=" title3">Mon Profile </h2>{" "}
                </Link>
              </li>
              <li>
                <Link to="/liste">
                  {" "}
                  <h2 className=" title3"> Ma liste </h2>{" "}
                </Link>
              </li>
              <li>
                {" "}
                <Link to="/MesRecettes">
                  {" "}
                  <h2 className=" title3">Mes recettes </h2>{" "}
                </Link>{" "}
              </li>
              <li>
                {" "}
                <Link to="/favoris">
                  {" "}
                  <h2 className=" title3"> Mes favoris </h2>{" "}
                </Link>{" "}
              </li>
              <li>
                {" "}
